...
// System.out.println("\n" + this.managerword + "" + this.managerName + "\t " +
// this.managerID);
...
// System.out.print("Enter The New Staff Name (must use underscore replace
// space) :");
// String a = c.nextLine();
// super.setName(a);
...
// System.out.print("Enter The New Staff Address (must use underscore replace
// space) :");
// String b = c.nextLine();
// super.setAddress(b);
...
// System.out.print("Enter The New Staff Bank Account Name (must use underscore
// replace space) :");
// String d = c.nextLine();
// super.setBname(d);
...
// if (line.contains(id)) {
// String newValue = "";
// System.out.println("Enter the old value that you want to change (Name/Phone
// Number/Bank Name) : ");
// System.out.print("Such As (anson/1234567/Public Bank) : ");
// String oldValue = c.next();

// System.out.print("Do You Want To Change Your Old Record [" + oldValue + "]
// (Y/N): ");
// String choice = c.next();
// char com = choice.charAt(0);

// if (com == 'Y' || com == 'y') {
// System.out.println("If Some Value need to use space, it must use underscore
// replace space");
// System.out.print("Enter the new value that can replace the old value [" +
// oldValue + "] : ");
// newValue = c.next();
