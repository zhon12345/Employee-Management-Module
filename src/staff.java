...
// public staff(String name, String ID, String address, String email, String
// Mphone, String Bname, String password,
...
// " " + this.getAddress() + " "
// + this.getMphone() + " "
// + this.getEmail() + " " + this.getIC() + " " + this.getBname() + " " +
// this.getAccounubmer() + " "
...
// return "\n[Personal Detail] \n"
// + "Name : " + this.getName() + "(" + this.getID() + ")" + " Address : " +
// this.getAddress()
// + "\nPhone Number : " + this.getMphone() + " Email : " + this.getEmail()
// + "\nIdentity Card : " + this.getIC()
// + "\n\n[Payment Detail] "
// + "\nBank Name : " + this.getBname() + " Account Number : " +
// this.getAccounubmer()
// + "\nTotal Salary : " + this.getSalary() + " Hours rate : " +
// this.getHsalary()
// + "\n";
